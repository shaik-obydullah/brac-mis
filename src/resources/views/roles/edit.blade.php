...
<div class="mb-6">
    ...
    <p class="text-gray-600 mt-1">Update the role name and its permissions</p>
</div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <form action="{{ route('roles.update', $role) }}" method="POST">
        ...
        <div class="max-w-lg">
            ...
            <input type="text" name="name" value="{{ old('name', $role->name) }}" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-purple-500 focus:border-purple-500">
        ...
        <div class="flex items-center gap-4 mt-8 pt-6 border-t border-gray-200">
            <button type="submit" class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2.5 rounded-lg font-medium">Update Role</button>
