        ...
        <div class="max-w-7xl mx-auto px-4 py-16 text-center">
            ...
            <form method="GET" action="{{ route('job-board.index') }}" class="mt-8 max-w-2xl mx-auto flex flex-col sm:flex-row gap-3">
                <div class="flex-1 relative">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Search by name, occupation, skill, phone..." class="w-full pl-12 pr-4 py-3 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pink-400">
                </div>
